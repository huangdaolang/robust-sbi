...
from nflows_pkg.distributions.base import Distribution
...
class Flow(Distribution):
    ...
    def _log_prob(self, inputs, context):
        ...
        embedded_hidden, embedded_context = self._embedding_net(context)
        ...
        return log_prob + logabsdet, embedded_context, embedded_hidden

    def _sample(self, num_samples, context):
        _, embedded_context = self._embedding_net(context)
        if self._context_used_in_base:
