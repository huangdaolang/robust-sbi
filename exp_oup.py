...
if __name__ == "__main__":
    ...
    parser.add_argument("--pre-generated-obs", type=bool, default=True, help="generate observation data online or not")
    parser.add_argument("--keep-inference", type=bool, default=False, help="save inference model or not")
